from logic import Youtube_page
import unittest
import time
...
class YoutubeTests(unittest.TestCase):
    ...
    def test_change_video_resoultion_to360p(self):
        self.youtube_page = Youtube_page("http://www.youtube.com")
        self.youtube_page.search_flow("Python Programming")
        self.youtube_page.play_random_video_flow()
        self.youtube_page.skip_ad_flow()
        self.youtube_page.change_video_resolution_flow()
        self.current_resolution = self.youtube_page.get_current_video_resolution()
        self.assertIn('360p',self.current_resolution)
